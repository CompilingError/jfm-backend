...
class TagServiceTests {
  ...
  void create_duplicate_shouldThrow() {
    ...
    assertThrows(TagAlreadyExistException.class, () -> tagService.create(new TagDTO("test_tag_1")));
  ...
  void update_duplicateName_shouldThrow() {
    ...
    assertThrows(
        TagAlreadyExistException.class, () -> tagService.update(1L, new TagDTO("test_tag_1")));
  ...
  void update_idNotFound_shouldThrow() {
    ...
    assertThrows(IdNotFoundException.class, () -> tagService.update(10L, new TagDTO("thriller")));
