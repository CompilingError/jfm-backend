...
public class MovieService {
    ...
    public Page<MovieDTO> findByArtists(List<Long> artistIds,  String mode, Pageable pageable) {
        ...
        return movieRepo.findAllHavingAllArtists(artistIds, artistIds.size(), pageable).map(this::toDto);
    }


    @Transactional
    public MovieDTO create(MovieCreateDTO req) throws  DuplicateFileImportException, IllegalArgumentException {
