...
public interface MovieRepo extends JpaRepository<MovieFileEntity, Long> {
  ...
  @Query("""
    ...
    """)
  Page<MovieFileEntity> findAllHavingAnyArtist(@Param("artistIds") List<Long> artistIds, Pageable pageable);
  ...
  @Query("""
    ...
    """)
  Page<MovieFileEntity> findAllHavingAllArtists(@Param("artistIds") List<Long> artistIds,
